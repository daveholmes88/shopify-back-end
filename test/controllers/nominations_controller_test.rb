...
class NominationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nomination" do
    assert_difference('Nomination.count') do
      post nominations_url, params: { nomination: { movie_id: @nomination.movie_id, user_id: @nomination.user_id } }
    end
  ...
  test "should update nomination" do
    patch nomination_url(@nomination), params: { nomination: { movie_id: @nomination.movie_id, user_id: @nomination.user_id } }
